...
{/* Hero Section */}
      <div className="relative bg-indigo-500 text-white py-6 sm:py-8 md:py-16 rounded-3xl mx-auto max-w-screen-xl px-4 sm:px-6 flex flex-col md:flex-row items-center overflow-hidden shadow-xl">
        {/* Gloss Overlay */}
      ...
      {/* Principles Section with Glassy Cards */}
      <div className="flex flex-col items-center justify-center my-8 sm:my-10 md:my-16">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">We value our customers.</h2>
        <p className="text-gray-600 mt-3 sm:mt-4 mb-8 sm:mb-10 text-center 2xl:text-base text-xs sm:text-sm">
      ...
      <div className="flex flex-col items-center text-gray-800 capitalize justify-center my-20 px-4">
      ...
      <div id="pricing-section" className="flex flex-col items-center space-y-6 my-10 md:my-16">
  ...
  <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-8">
    ...
    {/* Advanced Kit Card */}
      <div className="w-full max-w-xs rounded-lg overflow-hidden shadow-lg border-gray-300 border text-center bg-white">
        ...
        <div className="p-6">
          ...
          <Link to="/shop/kit/672d7ba0c81d69cfdaa0f513" className="px-4 py-2 bg-indigo-500 hover:text-white text-white rounded-lg font-thin hover:bg-indigo-700 transition duration-300">
            View
          </Link>
        </div>
      </div>
    ...
    {/* See More Kits Link */}
    <Link to="/shop" className="mt-10 text-indigo-600 hover:text-indigo-700 hover:underline text-lg 2xl:text-base cursor-pointer transition duration-300 transform hover:scale-105">
      View more kits
    </Link>
