                    ...
                    <table className="w-full bg-white text-left table-fixed">
                        <thead>
                            <tr className="bg-gray-100 border-b text-gray-800">
                                <th className="py-3 px-4 text-xs md:text-sm font-medium w-1/5">
                                ...
                                <th className="py-3 px-4 text-xs md:text-sm font-medium w-1/5">Status</th>
                                <th className="py-3 px-4 text-xs md:text-sm font-medium w-1/5">
                                    <div className="flex items-center space-x-2">
                                ...
                                <th className="py-3 px-4 text-xs md:text-sm font-medium w-1/5">Details</th>
                            </tr>
                        </thead>
                        <tbody>
                            {orders.map((order) => (
                                <React.Fragment key={order.id}>
                                    <tr className="border-b hover:bg-gray-50 transition">
                                        <td className="py-3 px-4 text-xs md:text-sm font-medium w-1/5">{order.id}</td>
                                        <td className="py-3 px-4 text-xs md:text-sm font-medium w-1/5">{order.date}</td>
                                        <td className={`py-3 px-4 text-xs md:text-sm font-normal w-1/5 ${
                                        ...
                                        <td className="py-3 px-4 w-full">
                                            <button
                                                ...
                                                className="flex items-center justify-center px-4 py-2 text-xs md:text-sm font-semibold text-indigo-600 bg-gray-100 rounded-lg transition-transform transform hover:scale-105 hover:bg-indigo-100 hover:shadow-md"
                                            >
                                    ...
                                    {expandedOrderId === order.id && (
                                        <tr>
                                            <td colSpan="5" className="p-4 bg-gray-100">
                                                <h3 className="text-sm md:text-base font-medium mb-2 text-black">Order #{order.id}</h3>
                                                ...
                                                <h3 className="text-xs md:text-sm font-medium mb-2 text-gray-700">Items</h3>
                                                <ul className="space-y-1 mx-1">
                                                    {order.items.map((item) => (
                                                        <li key={item.id} className="flex justify-between text-xs md:text-sm border-b py-1">
                                                            <div className="flex items-center space-x-2">
